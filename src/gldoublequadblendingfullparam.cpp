/**
 *\file gldoublequadblendingfullparam.cpp
...
/**
 * \fn GLDoubleQuadBlendingFullParam::GLDoubleQuadBlendingFullParam(QWidget* parent): GLWidget(parent)
 * \brief Le constructeur creer tout les objets dont la scene à besoin
 */
GLDoubleQuadBlendingFullParam::GLDoubleQuadBlendingFullParam(QWidget* parent): GLWidget(parent)
{
